...
type Producer struct {
	data chan PizzaOrder // chan PizzaOrder is a channel that sends a struct of type PizzaOrder
	quit chan chan error // chan chan error is a channel that sends a channel of type error
}
